...
interface DashboardData {
  ...
  todayLogged: boolean
  forgetAlerts: Array<{ id: number; topic: string; subject: string; retentionPercentage: number }>
  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--white)' }}>
      ...
      <div style={{ animation: 'heartbeat 1.8s ease-in-out infinite' }}>
        <svg width="60" height="60" viewBox="0 0 200 180">
          <defs>
            <radialGradient id="hg3" cx="50%" cy="38%" r="62%">
              <stop offset="0%" stopColor="#fad4de"/>
              <stop offset="100%" stopColor="#c4728a"/>
            </radialGradient>
          </defs>
          <path d="M100 162 C100 162 14 106 14 54 C14 29 34 14 60 14 C75 14 88 21 100 34 C112 21 125 14 140 14 C166 14 186 29 186 54 C186 106 100 162 100 162Z" fill="url(#hg3)"/>
        </svg>
      </div>
    </div>
  )
